...
def _show_all_config(settings: Settings) -> None:
    ...
    if settings.output_format == "json":
        ...
        rows = [
            ...
            ["health_report_dir", str(settings.health_report_dir)],
            ["dataset_lookup_enabled", str(settings.dataset_lookup_enabled)],
            ["dataset_services", ", ".join(settings.dataset_services)],
            ["remote_lookup_enabled", str(settings.remote_lookup_enabled)],
