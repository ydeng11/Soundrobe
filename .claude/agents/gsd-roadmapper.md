...
Reference full template: `/Users/ihelio/code/auto_tagger/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `/Users/ihelio/code/auto_tagger/.claude/get-shit-done/templates/state.md`.
