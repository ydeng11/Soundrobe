...
<reference>
@/Users/ihelio/code/auto_tagger/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/ihelio/code/auto_tagger/.claude/get-shit-done/references/user-profiling.md` to load:
