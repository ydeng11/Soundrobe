...
INSTALL_JS_GLOBAL="/Users/ihelio/code/auto_tagger/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/ihelio/code/auto_tagger/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
