...
```bash
INIT=$(node "/Users/ihelio/code/auto_tagger/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/ihelio/code/auto_tagger/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
