...
- Usage: Reference from command with `@/Users/ihelio/code/auto_tagger/.codex/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/ihelio/code/auto_tagger/.codex/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/ihelio/code/auto_tagger/.codex/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
