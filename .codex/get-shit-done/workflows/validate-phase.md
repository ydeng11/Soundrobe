...
```
Agent(
  prompt="Read /Users/ihelio/code/auto_tagger/.codex/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/ihelio/code/auto_tagger/.codex/get-shit-done/templates/VALIDATION.md`
