...
<required_reading>
@/Users/ihelio/code/auto_tagger/.codex/get-shit-done/references/user-story-template.md
@/Users/ihelio/code/auto_tagger/.codex/get-shit-done/references/spidr-splitting.md
@/Users/ihelio/code/auto_tagger/.codex/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@/Users/ihelio/code/auto_tagger/.codex/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@/Users/ihelio/code/auto_tagger/.codex/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@/Users/ihelio/code/auto_tagger/.codex/get-shit-done/references/spidr-splitting.md`. Briefly:
