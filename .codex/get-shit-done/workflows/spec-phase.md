...
```bash
INIT=$(node "/Users/ihelio/code/auto_tagger/.codex/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/ihelio/code/auto_tagger/.codex/get-shit-done/templates/spec.md.
