...
| Mutation + media-safety slice | ⏳ reader core green; writer pending | Shared corpus includes production-written rich ID3 MP3 plus FLAC/WAV/OGG/APE/malformed and FFmpeg-encoded M4A/MP4/Opus/AIFF; Rust reader matches all normalized DTOs. Raw Electron ID3 lyrics object leakage and MP3 compilation write→read `null` are characterized separately. No Rust writer, queue, or mutation yet. Next: no-op/MP3 payload-hash writer parity. |
