...
| Mutation + media-safety slice | ⏳ seven writable formats green; APE characterized; FLAC edges/batch pending | Seven formats dispatch through one queue; AIFF has exact unsupported parity. APE characterization records deterministic APEv2 replacement: rich/repeated/provider fields read back, identical rewrite emits identical bytes despite legacy full-rewrite outcome, null clears, trailing ID3v1 is intentionally removed, and tag-free Monkey audio core remains exact. PENDING: Rust APE core, FLAC ghost/APE/duplicate/insufficient-padding edges, and batch. |
